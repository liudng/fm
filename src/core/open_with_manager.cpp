...
void OpenWithManager::setDefaultApplication(const QString &mimeType,
...
QString OpenWithManager::systemDefault(const QString &mimeType) {
    ...
    QProcess proc;
    proc.start(QStringLiteral("xdg-mime"), {QStringLiteral("query"), QStringLiteral("default"), mimeType});
